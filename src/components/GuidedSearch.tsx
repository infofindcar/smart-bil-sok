  ...
  return (
    <div className="w-full max-w-4xl lg:max-w-5xl mx-auto">
      ...
      >
        ...
        {/* Input area */}
        <div
          className="px-4 md:px-6 lg:px-8 pb-8 pt-3 border-t border-border/40 shrink-0 bg-gradient-to-b from-card/40 to-card/80 backdrop-blur-sm safe-pb rounded-none"
        >
