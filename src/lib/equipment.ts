...
export const EQUIPMENT_TAGS: EquipmentTag[] = [
  ...
  // Specifika ljudmärken — visas före generiskt "Premiumljud" så att Bose syns som "Bose" på kortet.
  { key: 'bose', label: 'Bose-ljud', pattern: /\bbose\b/i, category: 'audio' },
  { key: 'bw_audio', label: 'Bowers & Wilkins', pattern: /\b(b&w|bowers)\b/i, category: 'audio' },
  { key: 'harman_audio', label: 'Harman Kardon', pattern: /\b(harman|h\/k|h&k)\b/i, category: 'audio' },
  { key: 'burmester_audio', label: 'Burmester-ljud', pattern: /\bburmester\b/i, category: 'audio' },
  { key: 'bang_olufsen_audio', label: 'Bang & Olufsen', pattern: /\b(bang\s*&?\s*olufsen|b&o)\b/i, category: 'audio' },
  { key: 'meridian_audio', label: 'Meridian-ljud', pattern: /\bmeridian\b/i, category: 'audio' },
  { key: 'premium_audio', label: 'Premiumljud', pattern: /\b(premium\s*audio|premium\s*ljud|premiumljud)\b/i, category: 'audio' },
