      ...
      style={{
        ...
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-10">
          <div className="relative">
            ...
            <p className="absolute bottom-[18%] right-[-2%] text-[10px] sm:text-xs drop-shadow-[0_2px_6px_rgba(0,0,0,0.6)] whitespace-nowrap text-secondary font-sans font-extrabold md:text-base">Din objektiva bilrådgivare</p>
          </div>
        </div>
